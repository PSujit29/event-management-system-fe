  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center bg-white px-4 py-8 text-center">
      <div className="max-w-3xl w-full">
        <h1 className="mb-4 text-[clamp(.75rem,6vw,5rem)] font-black leading-tight tracking-tight text-slate-900">Work In Progress</h1>

        <div className="flex items-center justify-center gap-3">
          <h2 className="text-[clamp(1rem,3vw,1.5rem)] font-bold text-slate-600">Under Construction</h2>
